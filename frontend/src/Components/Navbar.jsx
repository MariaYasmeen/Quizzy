...
const Navbar = () => {
  ...
  return (
    <>
            ...
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end soft-dropdown" aria-labelledby="userDropdown">
                  {user ? (
                    <>
                      <li className="dropdown-item-text">Logged in as: {user.name}</li>
                      <li className="dropdown-item-text">Email: {user.email}</li>
                      <li>
      ...
      {logoutMessage && <div className="alert alert-success text-center mt-3">{logoutMessage}</div>}
    </>
  );
};
